...
A scraperJSON scraper demonstrating all the described features is shown in figure 1, along with the results of an example scraping operation. The scraperJSON specification is available on Github: https://github.com/ContentMine/scraperJSON, and our collection of scrapers for the scholarly literature is available at: https://github.com/ContentMine/journal-scrapers.